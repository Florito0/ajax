...
async showConfirmation(message) {
    return new Promise((resolve) => {
        // 1. On utilise les nouvelles classes CSS unifiées
        const modalHtml = `
        ...
        // 2. On ajoute la classe .show pour déclencher l'animation d'ouverture
        ...
        // 3. La fonction de nettoyage gère maintenant l'animation de fermeture
        const cleanup = () => {
            document.body.classList.remove('modal-open'); // Réactiver le scroll
            modal.classList.add('closing'); // Déclencher l'animation de fermeture
        ...
        // 4. Bloquer le scroll de la page en arrière-plan
